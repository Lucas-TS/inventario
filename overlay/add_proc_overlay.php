<div id="bloco-overlay" class="bloco-overlay">
    <form name="add_proc_form" method="post" accept-charset="UTF-8" id="add_proc_form" onsubmit="insertProc(event)">
        ...
        <div id="linha-1" class="linha">
            ...
            <div id="b-line-add-proc-1" class="b-line"><label for="marca-proc" class="label">Marca:</label>
                <input id="marca-proc" name="marca-proc" type="text" class="input fixedBox" placeholder="Escolha a marca" style="width:250px" readonly required title="Selecione na lista">
            ...
            <div id="h-spacer"></div>
            <div id="b-line-add-proc-2" class="b-line"><label for="modelo-proc" class="label">Modelo:</label>
                <input id="modelo-proc" name="modelo-proc" type="text" class="input" placeholder="Digite o modelo" style="width:250px" required title="Ex.: Core i5-12400, Ryzen 3 2200G">
            </div>
        </div>
        <div id="linha-2" class="linha">
            <div id="h-line-add-proc-2" class="h-line">Informações complementares:</div>
            <div id="b-line-add-proc-3" class="b-line"><label for="ger-proc" class="label">Geração:</label>
                <input id="ger-proc" name="ger-proc" type="number" class="input" placeholder="" style="width:100px" title="Somente número. Ex.: 1, 2, 3, ...">
            </div>
            <div id="h-spacer"></div>
            <div id="b-line-add-proc-4" class="b-line"><label for="skt-proc" class="label">Socket:</label>
                <input id="skt-proc" name="skt-proc" type="text" class="input box" placeholder="" style="width:100px" required title="Ex.: AM4, AM5, LGA 1155, LGA 1200">
                <div id="suggestions-skt-proc" class="suggestions-box skt-proc"></div>
            </div>
            <div id="h-spacer"></div>
            <div id="b-line-add-proc-5" class="b-line"><label for="seg-proc" class="label">Seguimento:</label>
                <input id="seg-proc" name="seg-proc" type="text" class="input fixedBox" placeholder="Escolha" style="width:150px" readonly required title="Selecione na lista">
        ...
        <div id="linha-3" class="linha">
            ...
            <div id="b-line-add-proc-6" class="b-line"><label for="pcores-proc" class="label">P-Cores:</label>
                <input id="pcores-proc" name="pcores-proc" type="number" class="input" placeholder="" style="width:100px" required title="Somente número. Ex.: 1, 2, 3, ...">
            </div>
            <div id="h-spacer"></div>
            <div id="b-line-add-proc-7" class="b-line"><label for="ecores-proc" class="label">E-Cores:</label>
                <input id="ecores-proc" name="ecores-proc" type="number" class="input" placeholder="" style="width:100px" title="Somente número. Ex.: 1, 2, 3, ...">
            </div>
            <div id="h-spacer"></div>
            <div id="b-line-add-proc-8" class="b-line"><label for="threads-proc" class="label">Threads:</label>
                <input id="threads-proc" name="threads-proc" type="number" class="input" placeholder="" style="width:100px" required title="Somente número. Ex.: 1, 2, 3, ...">
            </div>
        </div>
        <div id="linha-4" class="linha">
            <div id="h-line-add-proc-4" class="h-line">Clock:</div>
            <div id="b-line-add-proc-9" class="b-line"><label for="clock-proc" class="label">Base:</label>
                <input id="clock-proc" name="clock-proc" type="text" class="input" placeholder="" style="width:100px" required title="Somente números com duas casas decimais. Ex.: 150 -> 1.50, 233 -> 2.33, 320 -> 3.20, ...">
                <span style="color:#AAAAAA">&nbsp;Ghz</span>
            </div>
            <div id="h-spacer"></div>
            <div id="b-line-add-proc-10" class="b-line"><label for="turbo-proc" class="label">Máximo (turbo):</label>
                <input id="turbo-proc" name="turbo-proc" type="text" class="input" placeholder="" style="width:100px" title="Somente números com duas casas decimais. Ex.: 366 -> 3.66, 280 -> 2.80, 470 -> 4.70, ...">
                <span style="color:#AAAAAA">&nbsp;Ghz</span>
            </div>
            <div id="h-spacer"></div>
        </div>
        <div id="linha-5" class="linha">
            ...
            <div id="b-line-add-proc-11" class="b-line"><span class="label">Tipos:</span>
        ...
        <div id="linha-6" class="linha">
            ...
            <div id="b-line-add-proc-12" class="b-line">
