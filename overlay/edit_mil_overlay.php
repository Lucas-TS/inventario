<div id="bloco-overlay" class="bloco-overlay" style="width:850px">
    <form name="edit_mil_form" method="post" accept-charset="UTF-8" id="edit_mil_form" onsubmit="editarMil(event)">
        ...
        <div id="linha-3" class="linha">
            <div id="h-line-edit-mil-1" class="h-line">Informações básicas:</div>
            <div id="b-line-edit-mil-5" class="b-line" style="flex:1">
        ...
        <div id="linha-1" class="linha">
            <div id="h-line-edit-mil-1" class="h-line">Informações pessoais:</div>
            <input id="hidden-id-edit-mil" name="hidden-id-edit-mil" type="hidden" value="">
            <div id="b-line-edit-mil-1" class="b-line" style="width:100%"><label class="label" for="nc-edit-mil">Nome completo:</label>
        ...
        <div id="linha-2" class="linha">
            <div id="h-line-edit-mil-2" class="h-line">Informações complementares:</div>
            <div id="b-line-edit-mil-2" class="b-line"><label class="label" for="pg-edit-mil">Posto/Graduação:</label>
            ...
            <div id="h-spacer"></div>
            <div id="b-line-edit-mil-3" class="b-line" style="flex:1"><label class="label" for="ng-edit-mil">Nome de guerra:</label>
            ...
            <div id="b-line-edit-mil-4" class="b-line" style="width:100%"><label class="label" for="sec-edit-mil">Seção:</label>
