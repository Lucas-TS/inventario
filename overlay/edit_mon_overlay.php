<div id="bloco-overlay" class="bloco-overlay" style="width:700px">
    <form name="edit_mon_form" method="post" accept-charset="UTF-8" id="edit_mon_form" onsubmit="editartMon(event)">
        <div class="header">
        ...
        <div id="linha-1" class="linha">
            <div id="h-line-edit-mon-1" class="h-line">Informações básicas:</div>
            <div id="b-line-edit-mon-1" class="b-line"><label class="label" for="marca-edit-mon">Marca:</label>
            ...
            <div id="h-spacer"></div>
            <div id="b-line-edit-mon-2" class="b-line"><label class="label" for="modelo-edit-mon">Modelo:</label>
        ...
        <div id="linha-2" class="linha">
            <div id="h-line-edit-mon-2" class="h-line">Tela:</div>
            <div id="b-line-edit-mon-3" class="b-line"><label class="label" for="tam-edit-mon">Tamanho:</label>
            ...
            <div id="h-spacer"></div>
            <div id="b-line-edit-mon-4" class="b-line"><label class="label" for="resh-edit-mon">Resolução:</label>
...
Ex.: 1024, 1280, 1920, 1440, ...">
                ...
                <input id="resv-edit-mon" name="resv-mon" type="number" class="input" placeholder="Vertical" style="width:100px" required title="Somente números (normalmente o menor)
Ex.: 768, 720, 1080, 900, ...">
            </div>
        </div>
        <div id="linha-3" class="linha" style="justify-content:space-between">
            <div id="h-line-edit-mon-3" class="h-line">Conexões:</div>
            <div id="b-line-edit-mon-5" class="b-line"><label class="label" for="qtde-hdmi">HDMI:</label>
            ...
            <div id="h-spacer"></div>
            <div id="b-line-edit-mon-6" class="b-line"><label class="label" for="qtde-dp">DisplayPort:</label>
                <button title="Diminuir" type="button" id="menos" class="menos icon-button margin-bottom" disabled onclick="less(this, 'saude')"><?php include '../images/menos.svg'; ?></button>
            ...
            <div id="h-spacer"></div>
            <div id="b-line-edit-mon-7" class="b-line"><label class="label" for="qtde-dvi">DVI:</label>
                <button title="Diminuir" type="button" id="menos" class="menos icon-button margin-bottom" disabled onclick="less(this, 'saude')"><?php include '../images/menos.svg'; ?></button>
            ...
            <div id="b-line-edit-mon-8" class="b-line"><label class="label" for="qtde-vga">VGA:</label>
                <button title="Diminuir" type="button" id="menos" class="menos icon-button margin-bottom" disabled onclick="less(this, 'saude')"><?php include '../images/menos.svg'; ?></button>
            ...
            <div id="h-spacer"></div>
            <div id="b-line-edit-mon-9" class="b-line"><label class="label" for="qtde-usb">USB:</label>
                <button title="Diminuir" type="button" id="menos" class="menos icon-button margin-bottom" disabled onclick="less(this, 'saude')"><?php include '../images/menos.svg'; ?></button>
            ...
            <div id="h-spacer"></div>
            <div id="b-line-edit-mon-10" class="b-line"><label class="label" for="qtde-p2">P2:</label>
                <button title="Diminuir" type="button" id="menos" class="menos icon-button margin-bottom" disabled onclick="less(this, 'saude')"><?php include '../images/menos.svg'; ?></button>
