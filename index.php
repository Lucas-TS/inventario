...
<script>
  let refreshTimer = setTimeout(() => location.reload(), 300000); // 5 minutos
         ...
         <div id="bloco-card-vazio-1" class="card-vazio">
            <div id="card-pequeno-1" class="card">
               ...
               <div class=texto-card-pequeno>
                  <span id="span-computadores" class="fit-text"></span>
               </div>
            </div>
            <div id="card-pequeno-2" class="card">
               ...
               <div class=texto-card-pequeno>
                  <span id="span-perifericos" class="fit-text"></span>
               </div>
            </div>
            <div id="card-pequeno-3" class="card">
               ...
               <div class=texto-card-pequeno>
                  <span id="span-hardwares" class="fit-text"></span>
               </div>
            </div>
            <div id="card-pequeno-4" class="card">
               ...
               <div class=texto-card-pequeno>
                  <span id="span-softwares" class="fit-text"></span>
               </div>
            </div>
         </div>
            ...
            <div id="card-pequeno-5" class="card">
               <div class="titulo-card-pequeno link-card">
                  <a href="./add_pc.php" class="link-card">
                     ...
                     <span class="span-card-pequeno fit-text">
