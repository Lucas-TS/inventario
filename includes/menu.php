...
if (empty($avatar)) {
    $avatar = 'images/avatar01.png'; // Caminho padrão para o avatar
}
?>
<nav id="wb_PanelMenu1" style="display:inline-block;width:64px;height:48px;text-align:center;z-index:1;">
    ...
    <div id="PanelMenu1_markup">
        ...
        <ul role="menu" class="menu">
            ...
            <!-- Item OS -->
            <li role="menuitem" onclick="exibirSubmenu('os')">
                <a class="nav-link PanelMenu1-effect" style="cursor:pointer;">
                    <svg class="icon" version="1.0" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64">
                        <g>
                            <polygon points="44,2.344 44,16 57.656,16 "></polygon>
                            <path d="M40,24c-2.211,0-4-1.789-4-4V0H8C5.789,0,4,1.789,4,4v56c0,2.211,1.789,4,4,4h48c2.211,0,4-1.789,4-4V24H40 z M24,24h4c2.211,0,4,1.789,4,4s-1.789,4-4,4h-4c-2.211,0-4-1.789-4-4S21.789,24,24,24z M40,48H24c-2.211,0-4-1.789-4-4 s1.789-4,4-4h16c2.211,0,4,1.789,4,4S42.211,48,40,48z"></path>
                        </g>
                    </svg>
                    <span>Ordens de Serviço</span>
                    <svg id="expandir_os" class="icon sub" fill="none" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg">
                ...
                <ul id="submenu_os" class="submenu">
                    <!-- Item MANUTENÇÃO -->
                    <li>
                        <a href="lista.php?tabela=os_manutencao">
                            <span class="guia">├</span>
                            <svg class="icon" viewBox="0 0 30 30" version="1.1" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <li role="menuitem" onclick="exibirSubmenu('pc')">
                <a class="nav-link PanelMenu1-effect" style="cursor:pointer;">
                    <svg class="icon" viewBox="0 0 512 512" version="1.1" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M177.633,412.735v10.449c0,17.312,14.035,31.347,31.347,31.347h271.673c17.312,0,31.347-14.035,31.347-31.347v-10.449H177.633z"/>
        ...
        <div class="PanelMenu1-footer">
            <a onclick="exibirOverlayEditar(<?php echo $_SESSION['id']; ?>, 'avatar')" alt="Editar perfil" title="Editar perfil" class="PanelMenu1-footer-link">
                <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" class="icon-footer" stroke-width="0">
            ...
            <a onclick="exibirOverlay('./overlay/logout_overlay.html')" alt="Sair do sistema" title="Sair do sistema" class="PanelMenu1-footer-link">
                <svg class="icon-footer" viewBox="0 0 64 64" version="1.1" xmlns="http://www.w3.org/2000/svg" onclick="exibirOverlay('./overlay/logout_overlay.html')" alt="Sair do sistema">
                    <path d="M63 35 C63 34, 64 33, 64 32 L64 32 C64 31, 63 30, 63 29 L47 13 C46 12, 45 12, 44 12 C43 12, 42 12, 41 13 C40 14, 40 15, 40 16 C40 17, 40 18, 41 19 L50 28 L24 28 C22 28, 22 28, 21 29 C20 30, 20 31, 20 32 C20 33, 20 34, 21 35 C22 36, 22 36, 24 36 L50 36 L41 45 C40 46, 40 47, 40 48 C40 49, 40 50, 41 51 C42 52, 43 52, 44 52 C45 52, 46 52, 47 51 L63 35Z  M20 12 C21 12, 22 12, 23 11 L23 11 C23 10, 24 9, 24 8 C24 7, 23 6, 23 5 C22 4, 21 4, 20 4 L12 4 C8 4, 5 5, 3 8 C1 10, 0 13, 0 16 L0 48 C0 51, 1 54, 3 57 C5 59, 8 60, 12 60 L20 60 C21 60, 22 60, 23 59 C23 58, 24 57, 24 56 C24 55, 23 54, 23 53 C22 52, 21 52, 20 52 L12 52 C10 52, 10 52, 9 51 C8 50, 8 49, 8 48 L8 16 C8 15, 8 14, 9 13 C10 12, 10 12, 12 12 L20 12Z " />
                </svg>
            </a>
