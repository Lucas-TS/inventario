<div id="add_proc" class="bloco-overlay" onclick="event.stopPropagation();" onkeyup="event.stopPropagation();">
    <form name="add_proc_form" method="post" accept-charset="UTF-8" action="includes/add_proc.php" id="add_proc_form">
        ...
        <div id="linha-1" class="linha">
            ...
            <div id="b-line-1" class="b-line"><label class="label" for="marca">Marca:</label>
                <input id="marca-proc" name="marca" type="text" class="input openBox" placeholder="Digite a marca"
                    style="width:250px">
                <div id="suggestions-marca-proc" class="suggestions-box marca-proc">
                    <p id="p0" onclick="passarValor(1,'marca-proc','');">AMD</p>
                    <p id="p1" onclick="passarValor(2,'marca-proc','');">Intel</p>
                </div>
            </div>
            <div id="h-spacer"></div>
            <div id="b-line-2" class="b-line"><label class="label" for="modelo">Modelo:</label>
                <input id="modelo-proc" name="modelo" type="text" class="input" placeholder="Digite o modelo"
                    style="width:250px">
            </div>
        </div>
    </form>
    <script>
        console.log('leu script');
            ...
            inputs.forEach(input => {
                ...
                if (suggestionsDiv) {
                    input.addEventListener('click', (event) => {
                        ...
                        handleInputEvent(input, suggestionsDiv);
                    });
